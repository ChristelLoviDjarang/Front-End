...
console.log("Input: Christel, Ruth, Glorya"); // test encoding text input
console.log("Encoded: " + encode("Christel, Ruth, Glorya")); // test encoding text input
...
function Chatbot() {
  ...
  return (
    <div className="App w-100">
      <div className="card d-flex lovi flex-column vh-100 overflow-hidden w-100">
        <Header />
        <div
          className="card-body"
          style={
        ...
        >
          <div className="containerbot">
            ...
            <div className="row">
              <div className="col-sm-8 lopi pt-4">
                Hi, selamat semoga hari mu menyenangkan :)
              </div>
